...
client.once("ready", async () => {
    ...
    function reselectRandomPresence() {
        ...
        let presenceOtherActivitiesList = [
            ...
            { activities: [{ name: "Brave Browser", type: "PLAYING" }], status: "online" },
            { activities: [{ name: "Opera GX", type: "PLAYING" }], status: "online" },
            { activities: [{ name: "Tor Browser", type: "PLAYING" }], status: "online" },
            { activities: [{ name: "Internet Explorer", type: "PLAYING" }], status: "online" },
            { activities: [{ name: "Armor Games", type: "PLAYING" }], status: "online" },
            ...
            { activities: [{ name: "Heroes of Might and Magic", type: "PLAYING" }], status: "online" },
            { activities: [{ name: "Sally Face", type: "PLAYING" }], status: "online" },
            { activities: [{ name: "Fran Bow", type: "PLAYING" }], status: "online" },
            { activities: [{ name: "Slay The Spire", type: "PLAYING" }], status: "online" },
            { activities: [{ name: "Kingdom Rush", type: "PLAYING" }], status: "online" },
            { activities: [{ name: "Kingdom Rush Origins", type: "PLAYING" }], status: "online" },
            { activities: [{ name: "Kingdom Rush Frontiers", type: "PLAYING" }], status: "online" },
            { activities: [{ name: "Kingdom Rush Vengeance", type: "PLAYING" }], status: "online" },
            { activities: [{ name: "Red Dead Redemption 2", type: "PLAYING" }], status: "online" },
            { activities: [{ name: "ELDEN RING", type: "PLAYING" }], status: "online" },
            { activities: [{ name: "Tiny Bunny", type: "PLAYING" }], status: "online" },
            { activities: [{ name: "Celeste", type: "PLAYING" }], status: "online" },
            { activities: [{ name: "Dead Cells", type: "PLAYING" }], status: "online" },
            { activities: [{ name: "Ori and the Will of the Wisps", type: "PLAYING" }], status: "online" },
            { activities: [{ name: "Ori and the Blind Forest", type: "PLAYING" }], status: "online" },
            { activities: [{ name: "Garry's Mod", type: "PLAYING" }], status: "online" },
            { activities: [{ name: "Team Fortress 2", type: "PLAYING" }], status: "online" },
            { activities: [{ name: "Geometry Dash", type: "PLAYING" }], status: "online" },
            { activities: [{ name: "Little Nightmares", type: "PLAYING" }], status: "online" },
            { activities: [{ name: "Dying Light", type: "PLAYING" }], status: "online" },
            { activities: [{ name: "Dying Light 2", type: "PLAYING" }], status: "online" },
            { activities: [{ name: "Hotline Miami", type: "PLAYING" }], status: "online" },
            { activities: [{ name: "Hotline Miami 2", type: "PLAYING" }], status: "online" },
            { activities: [{ name: "Deep Rock Galactic", type: "PLAYING" }], status: "online" },
            { activities: [{ name: "Rain World", type: "PLAYING" }], status: "online" },
            { activities: [{ name: ":>", type: "PLAYING" }], status: "online" },
            { activities: [{ name: "Knighttron", type: "PLAYING" }], status: "online" },
        ];
    ...
    let allWallsOfText = [
        ...
        "Купіть PeaceDuke Premium і отримайте нові фічи для всього серверу тут - [_**This link was removed automatically by Discord because it was deemed malicious. You can learn more here - https://discord.com/safety .**_]",
        ":skull:",
        ":joy:",
        ":sob:",
        ":sunglasses:",
